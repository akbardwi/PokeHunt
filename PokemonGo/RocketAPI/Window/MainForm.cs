...
namespace PokemonGo.RocketAPI.Window
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            Text = @"PokeHunt v" + GetExecutingAssembly().GetName().Version;
            CenterToScreen();
        }
        ...
        public void CheckVersion()
        {
            try
            {
                ...
                ColoredConsoleWrite(Color.Green,
                    "You can find it at www.pokehunt.asia");
            }
            catch (Exception)
            {
        ...
        private static string DownloadServerVersion()
        {
            using (var wC = new WebClient())
                return
                    wC.DownloadString(
                        "https://raw.githubusercontent.com/akbardwi/PokeHunt/master/PoGo.NecroBot.Logic/Properties/AssemblyInfo.cs");
        }
